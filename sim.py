...
def run_cbgt_sweeps(stimArray, preset=None, rampingCTX=False, savedir=None,
    ...
    for stim in stimArray:
        sweepcount = ng.configureSweep(t, experiment='mc', rampingCTX=rampingCTX,
                                       preset=preset, Start=Start, popscale=popscale,
                                       BaseStim=BaseStim, WrongStim=stim,
                                       RightStim=stim,
                                       Dynamic=Dynamic, Choices=Choices, CxSTR=CxSTR,
                                       GPiExtEff=GPiExtEff, SNExtEff=STNExtEff,
                                       STNExtFreq=STNExtFreq, CxFSI=CxFSI, CxTh=CxTh,
